...
Kishuboard a dashboard extension of Kishu. With the interactive GUI provided by KishuBoard, you can browse, compare and search commits, checkout code/kernel variables to previous commits; branch out exploration etc. in a straightforward and intuitive way. This [video](https://youtu.be/2RnUnlYUVLc) gives an overview of Kishuboard's features.
...
4. **Search Commits.**
Locate a specific commits by filtering with commit messages, tags, or variable names that were modified.
