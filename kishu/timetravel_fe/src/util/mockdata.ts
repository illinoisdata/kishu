 ...
 * @LastEditTime: 2023-07-18 16:31:32
    ...
    new History({
      ...
      codes: [
        ...
        new Cell({
          ...
          version: 1002,
          content:
            "print('I enjoy coding, but my aesthetics may be not good enough to design a beautiful page')",
          execNum: 2,
        }),
        new Cell({
          oid: 5001,
    ...
    new History({
      ...
      codes: [
        new Cell({
          oid: 5001,
          version: 1003,
          content: "a = 'another history on the other branch~",
          execNum: 1,
        }),
        new Cell({
          oid: 5002,
          version: 1002,
          content: "print('hahahaha')",
          execNum: 2,
        }),
        new Cell({
          oid: 5001,
