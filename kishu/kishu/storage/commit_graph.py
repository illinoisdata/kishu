...
"""
MAX_BASE_SIZE = Config.get_config_entry('COMMIT_GRAPH', 'MAX_BASE_SIZE', 128)
MUL_SIZE = Config.get_config_entry('COMMIT_GRAPH', 'MUL_SIZE', 2)
...
"""
NODE_SIZE = Config.get_config_entry('COMMIT_GRAPH', 'NODE_SIZE', 256)  # bytes
NODE_HEADER_SIZE = Config.get_config_entry('COMMIT_GRAPH', 'NODE_HEADER_SIZE', 1)  # bytes
NODE_DATA_SIZE = NODE_SIZE - NODE_HEADER_SIZE
NODE_HEADER_BYTEORDER = Config.get_config_entry('COMMIT_GRAPH', 'NODE_HEADER_BYTEORDER', 'little')
