...
def test_record_history(tmp_kishu_path_os: Path, tmp_path):
    path_to_notebook = os.getcwd()
...
def test_full_checkout(tmp_kishu_path_os: Path, notebook_name: str, cell_num_to_restore: int, tmp_path):
    """
