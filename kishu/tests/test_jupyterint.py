...
class TestOnNotebookRunner:
    ...
    def test_checkout(self, tmp_kishu_path_os: Path, set_temp_notebook_path_env):
    ...
    def test_reattatchment(self, tmp_kishu_path_os: Path, set_temp_notebook_path_env):
        notebook = NotebookRunner(set_temp_notebook_path_env)
        vals = ['a']
        output = notebook.execute([], vals)
        assert output['a'] == 1
    ...
    def test_record_history(self, tmp_kishu_path_os: Path, set_temp_notebook_path_env):
        notebook = NotebookRunner(set_temp_notebook_path_env)
    ...
    def test_full_checkout(self, tmp_kishu_path_os: Path, set_temp_notebook_path_env, cell_num_to_restore: int):
        """
