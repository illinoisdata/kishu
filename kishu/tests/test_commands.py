...
class TestKishuCommand:
    ...
    def test_delete_basic(self, notebook_id, basic_execution_ids):
        branch_1 = "branch_1"
        KishuCommand.branch(notebook_id, branch_1, basic_execution_ids[1])

        delete_result = KishuCommand.delete_branch(notebook_id, branch_1)
    ...
    def test_delete_branch_none_existing_branch(
        ...
        delete_result = KishuCommand.delete_branch(notebook_id, "non_existing_branch")
